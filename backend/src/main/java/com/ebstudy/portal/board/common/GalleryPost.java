...
/**
 * 갤러리(005) 글 — V11 {@code gallery_posts}.
 *
...
public class GalleryPost extends Post {

    GalleryPost(Category category, User author, String title, String content, OffsetDateTime now) {
